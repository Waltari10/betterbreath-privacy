...
The App uses **Sign in with Apple** for account registration.
...
The Apple user identifier is stored on your device and in Apple's iCloud key-value storage (which syncs it across your devices). It is **not** sent to any server operated by us or any third party. It is used solely to identify your account across devices.
...
The App stores your breathing exercises, practice history, settings, and streak data locally on your device using Apple's on-device database. This data is automatically synced across your devices through your private iCloud account via Apple's CloudKit service. The synced data is stored in your personal iCloud storage and is not accessible to us. Apple's iCloud terms and privacy policy govern this data.
...
- **Apple user identifier**: Used solely to identify your account across devices. Not used for analytics, profiling, or advertising.
...
- **Apple user identifier**: Processed under **Article 6(1)(b) GDPR** (performance of a contract). When you sign in with Apple to create an account, processing your Apple user identifier is necessary to perform the service you requested. You can withdraw by deleting your account in Settings, which removes the identifier from all your devices.
...
When you **sign out** (without deleting your account), the Apple user identifier is removed but your app data remains in iCloud.

When you **delete your account**, all app data (exercises, progress, streaks) is permanently deleted from your device and iCloud across all synced devices. The Apple user identifier is also removed. To fully revoke the App's access to your Apple ID, you must additionally remove the App from your Apple ID settings (Settings > Apple ID > Sign-In & Security > Sign in with Apple).
...
This permanently deletes all your data (exercises, progress, streaks) from your device and iCloud across all synced devices, clears your Sign in with Apple credential, and resets the App to its initial state. To complete the process, we recommend also revoking the App's access in your Apple ID settings.
...
- **Data Linked to You**: Identifiers (Apple user identifier, used for account identity)
